        ...
        <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">
            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#"><img
                                src="{{ asset('assets3/images/flags/vietnam-flag.jpg') }}" alt="" height="15"
                                class="me-2">VietNam</a>
                        <a class="dropdown-item" href="#"><img
                                src="{{ asset('assets3/images/flags/us_flag.jpg') }}" alt="" height="15"
                                class="me-2">English</a>
                        <a class="dropdown-item" href="#"><img
                                src="{{ asset('assets3/images/flags/germany_flag.jpg') }}" alt="" height="15"
                                class="me-2">German</a>
                        <a class="dropdown-item" href="#"><img
                                src="{{ asset('assets3/images/flags/french_flag.jpg') }}" alt="" height="15"
                                class="me-2">French</a>
                    </div>
                </li>
                <!--end topbar-language-->
                ...
                <li class="dropdown topbar-item">
                    <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#"
                        role="button" aria-haspopup="false" aria-expanded="false" data-bs-offset="0,19">
                        <img src="{{ asset('assets3/images/users/avatar-1.jpg') }}" alt=""
