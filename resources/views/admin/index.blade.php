                            ...
                            <table class="table mb-0">
                                <tbody>
                                    <tr class="">                                                        
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets/images/flags/us_flag.jpg')}}" class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                    ...
                                    <tr class="">                                                        
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets/images/flags/spain_flag.jpg')}}" class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                    ...
                                    <tr class="">                                                        
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets/images/flags/french_flag.jpg')}}" class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                    ...
                                    <tr class="">                                                        
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets/images/flags/germany_flag.jpg')}}" class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                                    ...
                                    <tr class="">                                                        
                                        <td class="px-0 pb-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets/images/flags/baha_flag.jpg')}}" class="me-2 align-self-center thumb-sm rounded-circle" alt="...">
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    <tr>                                                        
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('')}}assets/images/logos/lang-logo/chatgpt.png" height="40" class="me-3 align-self-center rounded" alt="...">
                                    ...
                                    <tr>                                                        
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('')}}assets/images/logos/lang-logo/gitlab.png" height="40" class="me-3 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate"> 
                                    ...
                                    <tr>                                                        
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('')}}assets/images/logos/lang-logo/nextjs.png" height="40" class="me-3 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate"> 
                                    ...
                                    <tr>                                                        
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('')}}assets/images/logos/lang-logo/vue.png" height="40" class="me-3 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate"> 
                                                    <h6 class="m-0">Vue</h6>
                                    ...
                                    <tr>                                                        
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('')}}assets/images/logos/lang-logo/symfony.png" height="40" class="me-3 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate"> 
                            ...
                            <table class="table mb-0">
                                <tbody>
                                    ...
                                    <tr class="">                                                        
                                        <td class="px-0">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('assets/images/users/avatar-9.jpg')}}" height="36" class="me-2 align-self-center rounded" alt="...">
                                                <div class="flex-grow-1 text-truncate"> 
                                                    <h6 class="m-0 text-truncate">Steven Sharp </h6>
                                                    <a href="#" class="font-12 text-muted text-decoration-underline">#4521</a>                                                                                           
                                                </div><!--end media body-->
