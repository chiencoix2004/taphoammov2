        ...
        <ul class="navbar-item flex-row ms-lg-auto ms-0">
            ...
            <li class="nav-item dropdown language-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown"
                    ...
                    <img src="{{ asset('assets3/images/flags/vietnam.jpg') }}" class="flag-width" alt="flag">
                </a>

                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                            src="{{ asset('assets3/images/flags/vietnam-flag.jpg') }}" class="flag-width"
                            alt="flag"> <span class="align-self-center">&nbsp;Việt Nam</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                    ...
                    <div class="avatar-container">
                        <div class="avatar avatar-sm avatar-indicators avatar-online">
                            @if (Auth::user()->image == null)
                                <img src="{{ asset('assetsClient/images/profile/Profile.jpg') }}" alt="avatar"
